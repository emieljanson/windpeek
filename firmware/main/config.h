...
#if defined(CONFIG_BOARD_DRIVER_SEEEDSTUDIO_RETERMINAL_E1003)
#define AUTO_SLEEP_TIMEOUT_SEC 120
#elif defined(DEBUG_DEEP_SLEEP_WAKE)
...
// OTA Configuration
#define GITHUB_API_URL "https://api.github.com/repos/emieljanson/einkwind/releases/latest"
