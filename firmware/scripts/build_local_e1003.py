...
from build import run_idf, validate_board_config  # noqa: E402
...
def main():
    ...
    # This is generated scratch state, not a user configuration. Defaults must
    # take effect after board resource settings change between USB builds.
    ...
    validate_board_config("seeedstudio_reterminal_e1003", sdkconfig)
